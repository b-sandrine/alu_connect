...
class FirebaseErrorMapper {
  ...
  static AppException fromAuthException(FirebaseAuthException e) {
    return switch (e.code) {
      'user-not-found' => const AuthException('No account found with this email.'),
      'wrong-password' => const AuthException('Incorrect password.'),
      'email-already-in-use' => const AuthException('An account already exists with this email.'),
      'invalid-email' => const AuthException('The email address is invalid.'),
      'weak-password' => const AuthException('Password is too weak.'),
      'user-disabled' => const AuthException('This account has been disabled.'),
      'too-many-requests' => const AuthException('Too many attempts. Please try again later.'),
      'network-request-failed' => const NetworkException('No internet connection.'),
      'requires-recent-login' => const AuthException('Please sign in again to continue.'),
