...
class _$MessageEntityImpl extends _MessageEntity {
  ...
  @override
  String toString() {
    return 'MessageEntity(id: $id, conversationId: $conversationId, senderId: $senderId, text: $text, imageUrl: $imageUrl, sentAt: $sentAt)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, id, conversationId, senderId, text, imageUrl, sentAt);
